#ფუნქცია რომლითაც ვკითხულობთ ტექსტურ ფაილს
def load_accounts():
    accounts = {}
    try:
...
#ფუნქცია რომლტაც ცვლილებებს ვინახავთ
...
#შეაქვს ბალანსზე თანხა და ინახავს ცვლილებს
...
def withdraw(account_number, accounts):
    try:
        ...
        #გამოსატანი თანხა თუ არსებულზე მეტია თანხას არ მოაკლებს
        if amount <= balance:
            accounts[account_number]["balance"] -= amount
            save_accounts(accounts)
        else:
...
def change_pin(account_number, accounts):
    try:
        ...
        #მოწმდება ახალი პინი რიცხვებისგან თუ შედგება და 4 ციფრიანია
...
def create_account(accounts):
    try:
        ...
        #ამოწმებს ექაუნთის რიცხვი ციფრებისგან თუ შედგება და სიგრძე 5-ია
